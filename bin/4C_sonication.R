...
proc <- args[1]
build <- args[4]
genome <- paste("/var/www/html/w4cseq/lib/",args[4],"/","genome.fa",sep="")
...
system(paste("/var/www/html/w4cseq/bin/scripts/fastq_trunk.pl", file_in1, file_sel1, unzip))
system(paste("/var/www/html/w4cseq/bin/scripts/fastq_trunk.pl", file_in2, file_sel2, unzip))

system(paste("/var/www/html/w4cseq/bin/scripts/fastq_convert.pl", file_sel1, "> fastq_convert1.fq"))
system(paste("/var/www/html/w4cseq/bin/scripts/fastq_convert.pl", file_sel2, "> fastq_convert2.fq"))

system(paste("cp fastq_convert1.fq FASTQ_FOR_MAPPING1.fq"))
system(paste("cp fastq_convert2.fq FASTQ_FOR_MAPPING2.fq"))
system(paste("paste fastq_convert1.fq fastq_convert2.fq > fastq_convert.fqp"))
system(paste("/var/www/html/w4cseq/bin/scripts/fastq_filter2.pl fastq_convert.fqp > FASTQ_FILTERED.fqp"))

system(paste("cat FASTQ_FILTERED.fqp | awk '{print $1}' > FASTQ_FILTERED1.fq"))
system(paste("cat FASTQ_FILTERED.fqp | awk '{print $2}' > FASTQ_FILTERED2.fq"))

system(paste("/var/www/html/w4cseq/bin/bwa-0.7.12/bwa aln -t", proc, genome,"FASTQ_FILTERED1.fq >",file_sai1))
system(paste("/var/www/html/w4cseq/bin/bwa-0.7.12/bwa aln -t", proc, genome,"FASTQ_FILTERED2.fq >",file_sai2))

system(paste("/var/www/html/w4cseq/bin/bwa-0.7.12/bwa samse",genome,file_sai1," FASTQ_FILTERED1.fq >",file_sam1))
system(paste("/var/www/html/w4cseq/bin/bwa-0.7.12/bwa samse",genome,file_sai2," FASTQ_FILTERED2.fq >",file_sam2))
system(paste("/var/www/html/w4cseq/bin/samtools-1.2/samtools view -b",file_sam1,"-S >",file_bam1))
system(paste("/var/www/html/w4cseq/bin/samtools-1.2/samtools view -b",file_sam2,"-S >",file_bam2))
system(paste("/var/www/html/w4cseq/bin/samtools-1.2/samtools sort -n",file_bam1, file_sort1))
system(paste("/var/www/html/w4cseq/bin/samtools-1.2/samtools sort -n",file_bam2, file_sort2))
system(paste("/var/www/html/w4cseq/bin/samtools-1.2/samtools merge -n",file_bam,file_sort_bam1,file_sort_bam2))
system(paste("/var/www/html/w4cseq/bin/samtools-1.2/samtools sort", file_bam, "sonic_sort"))
system(paste("/var/www/html/w4cseq/bin/samtools-1.2/samtools view -bq 1 sonic_sort.bam > sonic_sort_unique.bam"))
system(paste("/var/www/html/w4cseq/bin/samtools-1.2/samtools index sonic_sort_unique.bam"))

system(paste("cp sonic_sort_unique.bam MAPPED_BAM.bam"))

system(paste("cp sonic_sort_unique.bam.bai MAPPED_BAM.bam.bai"))
