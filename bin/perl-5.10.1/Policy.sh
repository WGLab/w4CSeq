...
case "$perladmin" in
'') perladmin='mingyangcai@bioinform2.local' ;;
esac
...
case "$prefix" in
'') prefix='/var/www/html/w4cseq/bin/localPerl-5-10.1' ;;
esac
...
case "$siteprefix" in
'') if test "/var/www/html/w4cseq/bin/localPerl-5-10.1" = "/var/www/html/w4cseq/bin/localPerl-5-10.1"; then
	siteprefix="$prefix"
    else
	siteprefix='/var/www/html/w4cseq/bin/localPerl-5-10.1'
    fi
    ;;
esac
case "$vendorprefix" in
'') if test "" = "/var/www/html/w4cseq/bin/localPerl-5-10.1"; then
	vendorprefix="$prefix"
    else
	vendorprefix=''
    fi
...
'') if test "/var/www/html/w4cseq/bin/localPerl-5-10.1" = "/var/www/html/w4cseq/bin/localPerl-5-10.1"; then
	...
	installprefix='/var/www/html/w4cseq/bin/localPerl-5-10.1'
    fi
    ;;
esac
...
#     /var/www/html/w4cseq/bin/localPerl-5-10.1, so it isn't included here either.
#
...
# bin='/var/www/html/w4cseq/bin/localPerl-5-10.1/bin'
# scriptdir='/var/www/html/w4cseq/bin/localPerl-5-10.1/bin'
# privlib='/var/www/html/w4cseq/bin/localPerl-5-10.1/lib/perl5/5.10.1'
# archlib='/var/www/html/w4cseq/bin/localPerl-5-10.1/lib/perl5/5.10.1/x86_64-linux'
# man1dir='/var/www/html/w4cseq/bin/localPerl-5-10.1/man/man1'
# man3dir='/var/www/html/w4cseq/bin/localPerl-5-10.1/man/man3'
# Preserving custom html1dir
html1dir=' '
# Preserving custom html3dir
html3dir=' '
# sitebin='/var/www/html/w4cseq/bin/localPerl-5-10.1/bin'
# sitescript='/var/www/html/w4cseq/bin/localPerl-5-10.1/bin'
# sitelib='/var/www/html/w4cseq/bin/localPerl-5-10.1/lib/perl5/site_perl/5.10.1'
# sitearch='/var/www/html/w4cseq/bin/localPerl-5-10.1/lib/perl5/site_perl/5.10.1/x86_64-linux'
# Preserving custom siteman1dir
siteman1dir='/var/www/html/w4cseq/bin/localPerl-5-10.1/man/man1'
# Preserving custom siteman3dir
siteman3dir='/var/www/html/w4cseq/bin/localPerl-5-10.1/man/man3'
