...
R_HOME_DIR=
if test "${R_HOME_DIR}" = "/var/www/html/w4cseq/lib/localR/lib64/R"; then
   case "linux-gnu" in
   linux*)
     run_arch=`uname -m`
     case "$run_arch" in 
     ...
     if [ -x "/var/www/html/w4cseq/lib/localR/${libnn}/R/bin/exec/R" ]; then
        R_HOME_DIR="/var/www/html/w4cseq/lib/localR/${libnn}/R"
     elif [ -x "/var/www/html/w4cseq/lib/localR/${libnn_fallback}/R/bin/exec/R" ]; then
        R_HOME_DIR="/var/www/html/w4cseq/lib/localR/${libnn_fallback}/R"
